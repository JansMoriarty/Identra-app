                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                    <div class="flex items-center justify-end gap-2">
                                        <button
                                            @click="window.location.href = `/admin/guru/${transaction.id}/register-face`"
                                            title="Daftar Wajah"
                                            class="w-9 h-9 flex items-center justify-center rounded-full bg-green-50 hover:bg-green-100 dark:bg-green-500/10 dark:hover:bg-green-500/20 text-green-600 dark:text-green-400">
