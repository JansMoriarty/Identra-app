...
class MenuHelper
{
    ...
    public static function getMasterDataMenu()
    {
        return [
            [
                ...
                'icon' => 'user-profile',
                'subItems' => [
                    ['name' => 'Daftar Guru', 'path' => '/manajemen-pengguna/guru', 'pro' => false],
                    ['name' => 'Daftar User', 'path' => '/manajemen-pengguna/user', 'pro' => false],
                ],
            ],
            [
                'name' => 'Struktur & Posisi',
                'icon' => 'ui-elements',
                'subItems' => [
                    ['name' => 'Daftar Posisi', 'path' => '/positions', 'pro' => false],
                    ['name' => 'Posisi Guru', 'path' => '/guru-positions', 'pro' => false],
                ],
            ],
            [
                'name' => 'Data Akademik',
                'icon' => 'tables',
                'subItems' => [
                    ['name' => 'Mata Pelajaran', 'path' => '/subjects', 'pro' => false],
                    ['name' => 'Manajemen Kelas', 'path' => '/classrooms', 'pro' => false],
                ],
            ],
            [
                ...
                'icon' => 'support-ticket',
                'subItems' => [
                    ['name' => 'Jam Absensi', 'path' => '/attendance-rules', 'pro' => false],
                    ['name' => 'Lokasi Absensi', 'path' => '/locations', 'pro' => false],
                ],
            ],
        ];
    }

    public static function getAttendanceMenu()
    {
        return [
            [
                'name' => 'Absen Wajah',
                'icon' => 'ai-assistant', // Menggunakan AI assistant icon karena relevan dengan deteksi wajah
                'path' => '/blank', 
                'pro' => false
            ],
            [
    ...
    public static function getAcademicMenu()
    {
        return [
            [
                'name' => 'Jadwal Guru',
            ...
            [
                ...
                'icon' => 'task',
                'subItems' => [
                    ['name' => 'Periode Penilaian', 'path' => '/assessment-periods', 'pro' => false],
                    ['name' => 'Kategori Penilaian', 'path' => '/assessment-categories', 'pro' => false],
                    ['name' => 'Input Penilaian', 'path' => '/assessments', 'pro' => false],
                ],
            ],
        ];
    }
    ...
    public static function getMenuGroups()
    {
        return [
            [
                'title' => 'Main',
                'items' => self::getDashboardMenu()
            ],
            [
                'title' => 'Master Data',
                'items' => self::getMasterDataMenu()
            ],
            [
                'title' => 'Kehadiran & Cuti',
                'items' => self::getAttendanceMenu()
            ],
            [
                'title' => 'Kegiatan Akademik',
                'items' => self::getAcademicMenu()
            ],
            [
                'title' => 'Laporan & Analitik',
                'items' => self::getReportMenu()
            ]
        ];
    }
